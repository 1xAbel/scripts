local games = {
    ...
    [{8131063774}] = "https://raw.githubusercontent.com/1xAbel/scripts/main/ShatteredPsychoOnline.lua",
    [{1240123653}] = "https://raw.githubusercontent.com/1xAbel/scripts/main/ZombieAttack.lua",
}
